"""Integration tests — end-to-end CAN reader, pipeline, store, and writer."""
...
@pytest.mark.asyncio
async def test_pipeline_processes_frame(db_loader):
    """Pipeline receives a DecodedFrame and updates the in-memory SignalStore."""
    store = SignalStore()
    ...
    try:
        ...
        pass
@pytest.mark.asyncio
async def test_pipeline_with_computed_signals(db_loader):
